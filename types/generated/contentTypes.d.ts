...
export interface ApiFeatureFlagTokenFeatureFlagToken
  extends Struct.CollectionTypeSchema {
  collectionName: 'feature_flag_tokens';
  info: {
    displayName: 'Feature Flag Token';
    pluralName: 'feature-flag-tokens';
    singularName: 'feature-flag-token';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::feature-flag-token.feature-flag-token'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    contact: Schema.Attribute.Component<'utils.link', true>;
    ...
    term: Schema.Attribute.Component<'utils.link', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aboutUs: Schema.Attribute.Component<'commons.about-section', false>;
    cards: Schema.Attribute.Component<'commons.grid-cards', false>;
    contactForm: Schema.Attribute.Component<'commons.form-section', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiNavbarNavbar extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    logo: Schema.Attribute.Component<'utils.menu-button', false>;
    publishedAt: Schema.Attribute.DateTime;
    social: Schema.Attribute.Component<'utils.link', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiPrivacyPrivacy extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    document: Schema.Attribute.RichText & Schema.Attribute.Required;
    hero: Schema.Attribute.Component<'utils.hero', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiTableInformationTableInformation
  extends Struct.CollectionTypeSchema {
  collectionName: 'table_informations';
  info: {
    description: '';
    displayName: 'Table Information';
    pluralName: 'table-informations';
    singularName: 'table-information';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    transfer_view: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTransferTransfer extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    form_reservation: Schema.Attribute.Component<'commons.form-section', false>;
    hero: Schema.Attribute.Component<'utils.hero', false>;
    infoData: Schema.Attribute.Component<'commons.transfer-information', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::feature-flag-token.feature-flag-token': ApiFeatureFlagTokenFeatureFlagToken;
